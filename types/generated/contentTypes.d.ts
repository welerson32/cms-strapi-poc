...
export interface ApiNextEventNextEvent extends Struct.CollectionTypeSchema {
  collectionName: 'next_events';
  info: {
    displayName: 'Next Event';
    pluralName: 'next-events';
    singularName: 'next-event';
  };
  options: {
    draftAndPublish: true;
  };
